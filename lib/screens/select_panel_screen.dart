...
import 'package:mqtt_app/screens/panels/add_led_indicator_panel_screen.dart';
import 'package:mqtt_app/screens/panels/add_node_status_panel_screen.dart';
import 'package:mqtt_app/screens/panels/add_progress_panel_screen.dart';
import 'package:mqtt_app/screens/panels/add_slider_panel_screen.dart';
import 'package:mqtt_app/screens/panels/add_switch_panel_screen.dart';
import 'package:mqtt_app/screens/panels/add_text_output_panel_screen.dart';
import 'dart:math' as math;
import 'panels/add_button_panel_screen.dart';
import 'panels/add_text_input_panel_screen.dart';
import 'panels/add_combo_box_panel_screen.dart';
import 'panels/add_radio_buttons_panel_screen.dart';
import 'panels/add_multi_state_indicator_panel_screen.dart';
import 'panels/add_gauge_panel_screen.dart';
import 'panels/add_color_picker_panel_screen.dart';
                      ...
                      if (label == 'Button') {
                        final result =
                            await Navigator.push<Map<String, dynamic>>(
                              context,
                              MaterialPageRoute(
                                builder: (_) => const AddButtonPanelScreen(),
                              ),
                            );
                        ...
                        final result =
                            await Navigator.push<Map<String, dynamic>>(
                              context,
                              MaterialPageRoute(
                                builder: (_) => const AddSwitchPanelScreen(),
                              ),
                            );
                        if (result != null && context.mounted)
                          Navigator.pop(context, result);
                        ...
                        final result =
                            await Navigator.push<Map<String, dynamic>>(
                              context,
                              MaterialPageRoute(
                                builder: (_) => const AddSliderPanelScreen(),
                              ),
                            );
                        if (result != null && context.mounted)
                          Navigator.pop(context, result);
                        ...
                        final result =
                            await Navigator.push<Map<String, dynamic>>(
                              context,
                              MaterialPageRoute(
                                builder: (_) => const AddTextInputPanelScreen(),
                              ),
                            );
                        if (result != null && context.mounted)
                          Navigator.pop(context, result);
                        ...
                        final result =
                            await Navigator.push<Map<String, dynamic>>(
                              ...
                              MaterialPageRoute(
                                builder: (_) =>
                                    const AddTextOutputPanelScreen(),
                              ),
                            );
                        if (result != null && context.mounted)
                          Navigator.pop(context, result);
                        ...
                        final result =
                            await Navigator.push<Map<String, dynamic>>(
                              ...
                              MaterialPageRoute(
                                builder: (_) =>
                                    const AddNodeStatusPanelScreen(),
                              ),
                            );
                        if (result != null && context.mounted)
                          Navigator.pop(context, result);
                        ...
                        final result =
                            await Navigator.push<Map<String, dynamic>>(
                              context,
                              MaterialPageRoute(
                                builder: (_) => const AddComboBoxPanelScreen(),
                              ),
                            );
                        if (result != null && context.mounted)
                          Navigator.pop(context, result);
                        ...
                        final result =
                            await Navigator.push<Map<String, dynamic>>(
                              ...
                              MaterialPageRoute(
                                builder: (_) =>
                                    const AddRadioButtonsPanelScreen(),
                              ),
                            );
                        if (result != null && context.mounted)
                          Navigator.pop(context, result);
                        ...
                        final result =
                            await Navigator.push<Map<String, dynamic>>(
                              ...
                              MaterialPageRoute(
                                builder: (_) =>
                                    const AddLedIndicatorPanelScreen(),
                              ),
                            );
                        if (result != null && context.mounted)
                          Navigator.pop(context, result);
                        ...
                        final result =
                            await Navigator.push<Map<String, dynamic>>(
                              ...
                              MaterialPageRoute(
                                builder: (_) =>
                                    const AddMultiStateIndicatorPanelScreen(),
                              ),
                            );
                        if (result != null && context.mounted)
                          Navigator.pop(context, result);
                        ...
                        final result =
                            await Navigator.push<Map<String, dynamic>>(
                              context,
                              MaterialPageRoute(
                                builder: (_) => const AddProgressPanelScreen(),
                              ),
                            );
                        if (result != null && context.mounted)
                          Navigator.pop(context, result);
                        ...
                        final result =
                            await Navigator.push<Map<String, dynamic>>(
                              context,
                              MaterialPageRoute(
                                builder: (_) => const AddGaugePanelScreen(),
                              ),
                            );
                        if (result != null && context.mounted)
                          Navigator.pop(context, result);
                        ...
                        final result =
                            await Navigator.push<Map<String, dynamic>>(
                              ...
                              MaterialPageRoute(
                                builder: (_) =>
                                    const AddColorPickerPanelScreen(),
                              ),
                            );
                        if (result != null && context.mounted)
                          Navigator.pop(context, result);
                      } else {
                        // Other panel types coming soon
  ...
  void paint(Canvas canvas, Size s) {
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(2, 8, s.width - 4, s.height - 16),
...
class _SliderIconPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size s) {
    ...
    canvas.drawLine(
      Offset(2, s.height * 0.5),
      Offset(s.width - 2, s.height * 0.5),
      p,
    );
...
class _TextInputIconPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size s) {
    ...
    final path = Path()
      ..addRRect(
        RRect.fromRectAndRadius(
          Rect.fromLTWH(0, 0, s.width, s.height * 0.78),
          const Radius.circular(4),
        ),
      )
    ...
    final lp = Paint()
      ...
      ..strokeCap = StrokeCap.round;
    canvas.drawLine(
      Offset(s.width * 0.18, s.height * 0.3),
      Offset(s.width * 0.82, s.height * 0.3),
      lp,
    );
    canvas.drawLine(
      Offset(s.width * 0.18, s.height * 0.52),
      Offset(s.width * 0.65, s.height * 0.52),
      lp,
    );
  }
...
class _TextOutputIconPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size s) {
    ...
    canvas.drawLine(
      Offset(0, s.height * 0.38),
      Offset(s.width, s.height * 0.38),
      p,
    );
    canvas.drawLine(
      Offset(0, s.height * 0.62),
      Offset(s.width * 0.7, s.height * 0.62),
      p,
    );
  }
...
class _NodeStatusIconPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size s) {
    ...
    canvas.drawLine(
      Offset(0, s.height * 0.2),
      Offset(s.width * 0.5, s.height * 0.8),
      p,
    );
    canvas.drawLine(
      Offset(s.width * 0.15, 0),
      Offset(s.width * 0.15, s.height),
      p,
    );
    // wifi arcs on right
...
class _ComboBoxIconPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size s) {
    ...
    canvas.drawLine(
      Offset(0, s.height * 0.52),
      Offset(s.width * 0.12, s.height * 0.65),
      cp,
    );
    canvas.drawLine(
      Offset(s.width * 0.12, s.height * 0.65),
      Offset(s.width * 0.24, s.height * 0.38),
      cp,
    );
  }
...
class _ProgressIconPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size s) {
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(0, s.height * 0.2, s.width * 0.88, s.height * 0.6),
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(3, s.height * 0.28, s.width * 0.55, s.height * 0.44),
...
class _GaugeIconPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size s) {
    ...
    canvas.drawLine(
      center,
      Offset(
        center.dx + s.width * 0.38 * math.cos(needleAngle),
        center.dy + s.width * 0.38 * math.sin(needleAngle),
      ),
...
class _ColorPickerIconPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size s) {
    ...
    canvas.drawCircle(
      Offset(s.width * 0.62, s.height * 0.72),
      s.width * 0.14,
      _iconFill,
    );
    // color dots
    ...
    // thumb hole
    canvas.drawCircle(
      Offset(s.width * 0.38, s.height * 0.72),
      s.width * 0.12,
      Paint()
        ..color = Colors.white
        ..style = PaintingStyle.fill,
...
class _DateTimeIconPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size s) {
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(1, s.height * 0.15, s.width - 2, s.height * 0.8),
...
class _UriLauncherIconPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size s) {
    ...
    canvas.drawLine(
      Offset(s.width - 2, 2),
      Offset(s.width * 0.35, s.height * 0.65),
      p,
    );
    // bottom box
    canvas.drawPath(
...
class _LayoutDecoratorIconPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size s) {
    ...
    // inner dividers
    canvas.drawLine(
      Offset(s.width * 0.5, 1),
      Offset(s.width * 0.5, s.height - 1),
      p,
    );
    canvas.drawLine(
      Offset(1, s.height * 0.42),
      Offset(s.width - 1, s.height * 0.42),
      p,
    );
  }
