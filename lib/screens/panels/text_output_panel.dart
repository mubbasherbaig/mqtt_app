...
class _AddTextOutputPanelScreenState extends State<AddTextOutputPanelScreen> {
  ...
  @override
  void dispose() {
    _panelNameCtrl.dispose(); _topicCtrl.dispose(); _factorCtrl.dispose();
    _decimalPrecisionCtrl.dispose(); _unitCtrl.dispose(); super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(backgroundColor: Colors.white, elevation: 0,
          ...
          title: Text(l.addTextOutputPanel, style: const TextStyle(color: Colors.black, fontSize: 20, fontWeight: FontWeight.w600)),
      ...
      body: Form(key: _formKey, child: ListView(children: [
        ...
        _checkRow(l.showHistory, _showHistory, (v) => setState(() => _showHistory = v)),
        ...
        Column(children: [
          Padding(padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 6), child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            Text(l.textSize, style: const TextStyle(fontSize: 15, color: Colors.black87)),
            DropdownButton<String>(value: _textSize, underline: const SizedBox(),
