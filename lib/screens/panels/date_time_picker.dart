...
class AddDateTimePickerPanelScreen extends StatefulWidget {
  ...
  @override
  State<AddDateTimePickerPanelScreen> createState() => _AddDateTimePickerPanelScreenState();
}

class _AddDateTimePickerPanelScreenState extends State<AddDateTimePickerPanelScreen> {
  ...
  void _create() {
    if (_formKey.currentState!.validate()) {
      Navigator.pop(context, {'type': 'Date & Time Picker', 'label': _panelNameCtrl.text.trim(),
        'topic': _topicCtrl.text.trim(), 'pickerType': _pickerType, 'buttonColor': _buttonColor.value.toString(),
