  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(backgroundColor: Colors.white, elevation: 0,
          ...
          title: Text(l.addLedIndicatorPanel, style: const TextStyle(color: Colors.black, fontSize: 18, fontWeight: FontWeight.bold)),
      ...
      body: Form(key: _formKey, child: ListView(children: [
        ...
        _fieldRow(l.payloadOn, _payloadOnCtrl, required: true, validator: (v) => (v==null||v.isEmpty) ? l.required : null),
        _fieldRow(l.payloadOff, _payloadOffCtrl, required: true, validator: (v) => (v==null||v.isEmpty) ? l.required : null),
  ...
  Widget _iconRow(String label, bool isOn, Color color, AppLocalizations l) {
    ...
    return Column(children: [
      Padding(padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12), child: Row(children: [
        ...
        GestureDetector(onTap: () => _pickColor(isOn, l),
