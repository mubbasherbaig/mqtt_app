  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(backgroundColor: Colors.white, elevation: 0,
          ...
          title: Text(l.addBarcodeScannerPanel, style: const TextStyle(color: Colors.black, fontSize: 20, fontWeight: FontWeight.w600)),
      ...
      body: Form(key: _formKey, child: ListView(children: [
        ...
        Column(children: [
          Padding(padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 14), child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            ...
            GestureDetector(onTap: () => _pickColor(l), child: Container(width: 110, height: 36,
