  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(backgroundColor: Colors.white, elevation: 0,
          ...
          title: Text(l.addTextInputPanel, style: const TextStyle(color: Colors.black, fontSize: 20, fontWeight: FontWeight.w600)),
      ...
      body: Form(key: _formKey, child: ListView(children: [
        ...
        _checkRow(l.clearTextOnPublish, _clearTextOnPublish, (v) => setState(() => _clearTextOnPublish = v)),
